...
// }
// let album1 = myAlbum1("Feroz", "Rang-e-Mohabat");
// let album2 = myAlbum1("Danish", "Roshan Andhera");
// let album3 = myAlbum1("Usama", "Mausam-e-Dil");
// console.log(album1);
// console.log(album3);
// console.log(album2);
...
let album1 = myAlbum2("Feroz", "Rang-e-Mohabat", 55);
let album2 = myAlbum2("Danish", "Roshan Andhera", 80);
let album3 = myAlbum2("Usama", "Mausam-e-Dil");
console.log(album1);
console.log(album2);
console.log(album3);
export {};
